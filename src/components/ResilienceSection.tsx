    ...
    <div>
      ...
      >
        ...
        {articles.map((article, i) => {
          const colors = sourceColors[article.source] || { bg: 'from-gray-600 to-gray-800', text: article.source.charAt(0) }
          return (
            <a
              key={i}
              href={article.url}
            ...
            >
              ...
              <div className={`h-28 rounded-t-md bg-gradient-to-br ${colors.bg} flex items-center justify-center`}>
